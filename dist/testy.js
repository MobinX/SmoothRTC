...
window.stream = await (0, media_js_1.openVedio)();
...
await channel.subscribe('greeting', (message) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (message.data.id === myid) {
            ...
            if (Peers.length === 0) {
                ...
                if (peerindex !== -1) {
                    ...
                    yield Peers[peerindex].onmessage(message.data);
                    return;
                }
                else {
...
channel.presence.subscribe('enter', function (member) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield createPeer(member.clientId, false);
    });
});
channel.presence.subscribe('leave', function (member) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield removePeer(member.clientId);
    });
});
...
function createPeer(id, isPolite, initailRemoteMsg = null) {
    ...
    const peer = new index_js_1.Peer({
        id: id,
        ice: { iceServers },
        isPolite: isPolite,
        ...
        sendmsg: (msg) => __awaiter(this, void 0, void 0, function* () {
            yield sendmsg(msg);
        })
    });
    peer.setSelfStream(window.stream);
    if (initailRemoteMsg !== null)
        peer.onmessage(initailRemoteMsg);
    Peers.push(peer);
...
function sendmsg(msg) {
    return __awaiter(this, void 0, void 0, function* () {
        yield channel.publish('greeting', msg);
