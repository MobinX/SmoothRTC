...
const peer2_1 = __importDefault(require("./dist/peer2"));
(() => __awaiter(void 0, void 0, void 0, function* () {
    let webRt = new peer2_1.default(sendmsg, ably.auth.clientId, iceServers);
    ;
    ...
    ably.connection.once('connected').then(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!isWrtcInit) {
            webRt = new peer2_1.default(sendmsg, ably.auth.clientId, iceServers);
            isWrtcInit = true;
        }
    ...
    yield channel.subscribe('greeting', (message) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (message.clientId === myid) {
            ...
            if (message.data.to === myid) {
                ...
                console.log(message);
                yield webRt.onMessage(message.data.data, message.clientId);
            }
        }
    }));
